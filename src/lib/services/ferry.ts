...
export const FERRY_ROUTES: Record<string, FerryRouteConfig> = {
  ...
  "HOB-P11": {
    id: "HOB-P11",
    name: "Hoboken ↔ Pier 11/Wall St",
    terminals: ["Hoboken NJ Transit Terminal", "Pier 11/Wall Street"],
    baseCrossingTimeMin: 12,
    peakHeadwayMin: 20,
    offPeakHeadwayMin: 40,
    windCancelThresholdMph: 30,
    windDelayThresholdMph: 20,
  },
  "LIB-BFP": {
    id: "LIB-BFP",
    name: "Liberty Harbor ↔ Brookfield Place",
    terminals: ["Liberty Harbor", "Brookfield Place"],
    baseCrossingTimeMin: 8,
    peakHeadwayMin: 20,
    offPeakHeadwayMin: 40,
    windCancelThresholdMph: 30,
  ...
  "LIB-P11": {
    id: "LIB-P11",
    name: "Liberty Harbor ↔ Pier 11/Wall St",
    terminals: ["Liberty Harbor", "Pier 11/Wall Street"],
    baseCrossingTimeMin: 15,
    peakHeadwayMin: 30,
    offPeakHeadwayMin: 60,
    windCancelThresholdMph: 30,
    windDelayThresholdMph: 20,
  },
  "PI-BFP": {
    id: "PI-BFP",
    name: "Port Imperial ↔ Brookfield Place",
    terminals: ["Port Imperial/Weehawken", "Brookfield Place"],
    baseCrossingTimeMin: 12,
    peakHeadwayMin: 10,
    offPeakHeadwayMin: 20,
    windCancelThresholdMph: 30,
    windDelayThresholdMph: 20,
  },
  "PI-P11": {
    id: "PI-P11",
    name: "Port Imperial ↔ Pier 11/Wall St",
    terminals: ["Port Imperial/Weehawken", "Pier 11/Wall Street"],
    baseCrossingTimeMin: 25,
    peakHeadwayMin: 20,
    offPeakHeadwayMin: 40,
    windCancelThresholdMph: 30,
    windDelayThresholdMph: 20,
  ...
  "H14-BFP": {
    id: "H14-BFP",
    name: "Hoboken 14th St ↔ Brookfield Place",
    terminals: ["Hoboken 14th Street", "Brookfield Place"],
    baseCrossingTimeMin: 15,
    peakHeadwayMin: 30,
    offPeakHeadwayMin: 60,
    windCancelThresholdMph: 30,
